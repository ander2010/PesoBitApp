...
public class LogAdapter extends BaseAdapter {
    ...
    public long getItemId(int position) {
        return  (((Log)this.getItem(position)).getId() != null) ?((Log)this.getItem(position)).getId(): ((Log)this.getItem(position)).getIdRef();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            rowView = inflater.inflate(R.layout.reservation_item, parent, false);
        }
        ...
        Log item = this.items.get(position);
